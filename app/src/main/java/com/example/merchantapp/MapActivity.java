...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String mapsAddressLine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addressTextView = findViewById(R.id.currentLocation);
        ...
        selectlocationbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("addressLine", mapsAddressLine);
        ...
        try {
            ...
            if (addresses != null && !addresses.isEmpty()) {
                Address address = addresses.get(0);
                 mapsAddressLine = String.valueOf(address.getAddressLine(0));
    ...
    private void showLocationPermissionDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("OK", (dialogInterface, i) -> ActivityCompat.requestPermissions(MapActivity.this,
